...
from tools.imutils import cv_imread, separate_color, _var_max_interclass
...
def detect_bloom2(img, debug=False):
    ...
    for i in range(0, len(RES_1)):
        ...
        r1_area = (x2 - x1) * (y2 - y1)
        # 这又是个阈值啊啊啊啊
        if RES_1_FLAG[i] != 0 and (RES_1_PART_AREA[i] / r1_area > 0.3):  # 阈值类似于IoU 0.15 还是 0.5合适
    ...
    for i in range(0, len(RES_1)):
        ...
        if RES_1_PART_AREA[i]/r1_area > 0.05 and RES_1_FLAG[i] > 3:
            cv2.rectangle(img_bgr, (x1, y1), (x2, y2), (0, 0, 0), 2)  # 黑色框描绘的结果根据密度或者面积比例筛选出来的
...
if __name__ == '__main__':
    ...
    # ch #(UpG_161817, )
    # 1 正常晕染 UpG_161519 UpG_161314 UpG_161333
    imagePath = r'E:\DataSet\redline\UpG_redline\UpG_161519.jpg'
    # 1 轻微晕染 UpG_161356 UpG_161405 UpG_161441 UpG_161451<
    imagePath = r'E:\DataSet\redline\UpG_redline\UpG_161451.jpg'
    # 2 粗线晕染
